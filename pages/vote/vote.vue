<template>
	<view class="vote_body">
		...
		<view class="vote_three">
			<view class="vote_three_box tu1">
				<view class="three_box_top">
					<image class="images"
					src="../../static/paihangban/first.png" mode="aspectFill"></image>
				...
				<view class="three_box_bottom">
					<image class="images"
					:src="one.enterpriseLogo" mode="aspectFill"></image>
					<view class="bianhao">
						<p>编号:{{one.code}}号</p>
						<p>支持: <text>{{one.hit}}</text>次</p>
					</view>
					<view class="zhichi">
			...
			<view class="vote_three_box tu2">
				<view class="three_box_top">
					<image class="images"
					src="../../static/paihangban/twree.png" mode="aspectFill"></image>
				...
				<view class="three_box_bottom">
					<image class="images"
					:src="two.enterpriseLogo" mode="aspectFill"></image>
					<view class="bianhao">
						<p>编号:{{two.code}}号</p>
						<p>支持: <text>{{two.hit}}</text>次</p>
					</view>
					<view class="zhichi">
			...
			<view class="vote_three_box tu3">
				<view class="three_box_top">
					<image class="images"
					src="../../static/paihangban/three.png" mode="aspectFill"></image>
				...
				<view class="three_box_bottom">
					<image class="images"
					:src="three.enterpriseLogo" mode="aspectFill"></image>
					<view class="bianhao">
						<p>编号:{{three.code}}号</p>
						<p>支持: <text>{{three.hit}}</text>次</p>
					</view>
					<view class="zhichi">
			...
			<view class="vote_three_box">
				<view class="three_box_top">
					<image src="../../static/paihangban/last.png" mode="aspectFill"></image>
				...
				<view class="three_box_bottom">
					<image class="images"
					:src="four.enterpriseLogo" mode="aspectFill"></image>
					<view class="bianhao">
						<p>编号:{{four.code}}号</p>
						<p>支持: <text>{{four.hit}}</text>次</p>
					</view>
					<view class="zhichi">
		...
		<view class="bottom_lan">
			...
			<view class="bottom_cansai" @click="cansai_active">
				<text>立即参赛</text>
			</view>
		</view>
	</view>
...
<script>
	export default {
		data() {
			return {
				img: 'http://qilianxiangqin.oss-cn-beijing.aliyuncs.com/aqi/pload/2021/01/20/d6d34d2e-c104-4b74-9109-8218b0e0d6cc.png?Expires=2241854757&OSSAccessKeyId=LTAI4GBFk5WDFTUSnuimghyp&Signature=1Bd8pW2gtKGCxbeC%2BH9Gmd78nTc%3D',
				text_value: '',
				one: {},
				two: {},
				three: {},
				...
				.then(res => {
					...
					if (res.data.msg === '获取成功') {
						...
						for (var i=0;i<res.data.data.activityList.length;i++) {
							if (res.data.data.activityList[i] > 3) {
		...
		onNavigationBarButtonTap() {
			...
			uni.share({
				...
				type: 0,
				href: 'http://aqi.tdkj.online/lessonaqi/api/toupiao?activitymanageid=1',
				title:'快来和我一起投票吧！',
				success(res) {
